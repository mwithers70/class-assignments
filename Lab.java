...
//        fix by assigning thirdInt a value of 7.
    ...
    public static void playWithStrings() {
        ...
        System.out.println(String.format("Does the %s contain an apostrophe or dash: %b", fullName, (fullName.contains("'") || fullName.contains("-"))));
    }
...
>>>>>>> 833aa5f51767c4a099523c8a0b66c9862727eb47
