...
select customer_name, customer_zip from customers where customer_state = 'NC' or 'SC';
...
select customer_name, Title, artist, order_qty from  customers,.... 
select customer_name, unit_prie * 2 as retail_price.....
